import React, { createContext, forwardRef, createElement, useContext, useImperativeHandle, useEffect, Children, useRef, useReducer, useCallback, useMemo, Component, useLayoutEffect, useState } from 'react';
...
function isPlainObject(value) {
  if (!isObjectLike$7(value) || baseGetTag$7(value) != objectTag$6) {
    return false;
  }
...
var reIsNative$1 = RegExp('^' +
  funcToString$2.call(hasOwnProperty$i).replace(reRegExpChar$1, '\\$&')
...
var Map$4 = getNative$7(root$a, 'Map');
...
function hashHas$2(key) {
  var data = this.__data__;
  return nativeCreate$6 ? (data[key] !== undefined) : hasOwnProperty$g.call(data, key);
}
...
function assignValue(object, key, value) {
  ...
  if (!(hasOwnProperty$f.call(object, key) && eq$3(objValue, value)) ||
...
function baseIsArguments$2(value) {
  return isObjectLike$7(value) && baseGetTag$7(value) == argsTag$5;
}
...
var isArguments$4 = baseIsArguments$2(function() { return arguments; }()) ? baseIsArguments$2 : function(value) {
  return isObjectLike$7(value) && hasOwnProperty$e.call(value, 'callee') &&
...
typedArrayTags$1[mapTag$8] = typedArrayTags$1[numberTag$4] =
...
function baseIsTypedArray$2(value) {
  return isObjectLike$7(value) &&
    isLength$4(value.length) && !!typedArrayTags$1[baseGetTag$7(value)];
}
...
function keys$4(object) {
  return isArrayLike$5(object) ? arrayLikeKeys$2(object) : baseKeys$3(object);
}
...
/* Built-in method references that are verified to be native. */
var Set$2 = getNative$7(root$a, 'Set');
...
var dataViewCtorString$1 = toSource$3(DataView$3),
    ...
    setCtorString$1 = toSource$3(Set$3),
 ...
 * @returns {string} Returns the `toStringTag`.
 */
var getTag$3 = baseGetTag$7;

// Fallback for data views, maps, sets, and weak maps in IE 11 and promises in Node.js < 6.
if ((DataView$3 && getTag$3(new DataView$3(new ArrayBuffer(1))) != dataViewTag$5) ||
    (Map$5 && getTag$3(new Map$5) != mapTag$7) ||
    (Promise$4 && getTag$3(Promise$4.resolve()) != promiseTag$1) ||
    (Set$3 && getTag$3(new Set$3) != setTag$7) ||
    (WeakMap$4 && getTag$3(new WeakMap$4) != weakMapTag$3)) {
...
var symbolProto$3 = Symbol$7 ? Symbol$7.prototype : undefined,
...
function baseIsMap(value) {
  return isObjectLike$7(value) && getTag$4(value) == mapTag$5;
}
...
function baseIsSet(value) {
  return isObjectLike$7(value) && getTag$4(value) == setTag$5;
}
...
function isSymbol$4(value) {
  return typeof value == 'symbol' ||
    (isObjectLike$7(value) && baseGetTag$7(value) == symbolTag$2);
}
...
function toPath(value) {
  if (isArray$e(value)) {
    return arrayMap$3(value, toKey$5);
  }
  return isSymbol$4(value) ? [value] : copyArray(stringToPath$3(toString$3(value)));
}
...
var isObject$4 = function isObject(obj) {
...
var isPromise = function isPromise(value) {
  return isObject$4(value) && isFunction$3(value.then);
};
/**
...
function setIn(obj, path, value) {
  ...
  for (; i < pathArray.length - 1; i++) {
    ...
    if (currentObj && (isObject$4(currentObj) || Array.isArray(currentObj))) {
...
function useFormik(_ref) {
  ...
  var getFieldProps = useCallback(function (nameOrOptions) {
    var isAnObject = isObject$4(nameOrOptions);
...
function Formik(props) {
  ...
  ? isFunction$3(children) ? children(formikbag) : !isEmptyChildren(children) ? Children.only(children) : null : null);
}
...
const getFieldError = (fieldName, formikProps) => {
    const fieldError = get_1(formikProps, `errors.${fieldName}`);
    const isTouched = get_1(formikProps, `touched.${fieldName}`);
    if (!isTouched && formikProps.submitCount < 1)
        return "";
    return fieldError;
};
const processFilesWithCallback = (files, callback, readAs, encoding) => {
    const imgFiles = [];
    const remFiles = [];
...
const setValue = (value, formikProps, fieldProps) => {
    formikProps.setFieldValue(get_1(fieldProps, "name"), value);
};
...
const SelectField = (props) => {
    ...
    const emptyItemText = isString_1(emptyItem) ? emptyItem : "No option selected";
        ...
        React.createElement("div", { className: clsx("checkbox-container", isColumn ? "isColumn" : undefined) }, !isEmpty_1(options) ? (map_1(options, (item, index) => {
            return (React.createElement("div", { key: `${item.value}-${index}`, className: "checkbox-name" },
                React.createElement("label", { htmlFor: name },
                    item.name,
                    React.createElement("input", { className: "checkbox-input", type: "checkbox", name: `${name}-${item}`, id: `${name}-${item}`, value: item.value, checked: fieldValue?.includes(item.value), onChange: formikProps.handleChange, disabled: disabled, ...nativeProps }))));
        })) : (React.createElement("div", { className: "checkbox-name" },
            React.createElement("label", { htmlFor: name },
                React.createElement("input", { className: "checkbox-input", type: "checkbox", name: `${name}`, id: name, value: "false", checked: booleanValue || false, onBlur: formikProps.handleBlur, onChange: formikProps.handleChange, disabled: disabled, ...nativeProps }),
                booleanLabel)))),
        React.createElement(HelperText, { fieldProps: fieldProps, formikProps: formikProps })));
};
...
const Radio = (props) => {
    ...
    return (React.createElement("div", { className: clsx("radio-field", classNames) },
        ...
        React.createElement("div", { className: clsx("radio-container", isColumn ? "isColumn" : undefined) }, options.map((item) => (React.createElement("span", { key: item.value, className: "radio-name" },
            React.createElement("label", { htmlFor: name },
                item.name,
                React.createElement("input", { className: "radio-input", type: "radio", name: `${name}-${item}`, id: `${name}-${item}`, value: item.value, checked: fieldValue === item.value, onChange: formikProps.handleChange, disabled: disabled, ...nativeProps })))))),
        React.createElement(HelperText, { fieldProps: fieldProps, formikProps: formikProps })));
};
...
const ArrayField = (props) => {
    ...
    const values = get_1(formikProps, `values.${name}`);
...
const PhoneField = (props) => {
    ...
    const value = (get_1(formikProps, `values.${name}`) || "");
    useEffect(() => {
        if (value) {
...
const TextArea = (props) => {
    ...
    return (React.createElement("div", { className: clsx("textarea-field", classNames) },
        label && (React.createElement("label", { className: "textarea-label", htmlFor: name }, label)),
        React.createElement("div", { className: clsx("textarea-field-box") },
            React.createElement("textarea", { className: clsx("textarea-box"), placeholder: `${placeholder || ""}`, name: name, id: name, value: fieldValue || "", onBlur: formikProps.handleBlur, onChange: formikProps.handleChange, disabled: disabled, ...nativeProps })),
        React.createElement(HelperText, { fieldProps: fieldProps, formikProps: formikProps })));
};
...
const getConditionalOutput = (itemCondition, formikProps) => {
    const itemValue = get_1(formikProps, `values.${itemCondition.key}`);
...
const getConditionalProps = (itemConfig, formikProps) => {
    const conditionInstructions = itemConfig.condition;
    if (!conditionInstructions || isEmpty_1(conditionInstructions.values)) {
        return { finalProps: {} };
    }
...
const attachField = (type, component, props) => {
    if (isArray_1(type)) {
        map_1(type, (item) => (ComponentMapConfig[item] = { component, props }));
    }
    else
        ComponentMapConfig[type] = { component, props };
};
const setDefaultProps = (type, props) => {
    if (isArray_1(type)) {
        map_1(type, (item) => (ComponentMapConfig[item].props = {
...
const BuildFormRow = (props) => {
    ...
    const columnItems = get_1(schema, "columns");
    const rowSettings = {
        ...settings,
    };
    const colItems = isArray_1(schema)
        ? schema
        : isArray_1(columnItems)
            ? columnItems
            : [schema];
    const rowStyle = { marginBottom: rowSettings.verticalSpacing || 10 };
    return (React.createElement("div", { className: "row", style: rowStyle }, map_1(colItems, (item, index) => {
        ...
        return (React.createElement("div", { key: `${rowId}_field_${index}`, className: clsx(item.classNames, "isColumn"), style: {
            ...
            item.readOnlyProps &&
            isFunction_1(item.readOnlyProps.renderer)
...
const getUpdateSchema = (schema, formId) => {
    return map_1(schema, (schemaItem) => {
        if (isArray_1(schemaItem)) {
            return map_1(schemaItem, (item) => ({
                ...item,
                id: `${formId}_${uniqueId_1()}`,
            }));
        }
        return { ...schemaItem, id: `${formId}_${uniqueId_1()}` };
    });
};
const MLFormContent = (props) => {
    const { schema, formId, formikProps, settings } = props;
    const [formSchema, setFormSchema] = useState(schema);
    useEffect(() => {
        setFormSchema(getUpdateSchema(schema, formId));
    }, [schema]);
    return (React.createElement(React.Fragment, null, map_1(formSchema, (configRow, index) => {
