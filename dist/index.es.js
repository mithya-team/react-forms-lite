    ...
    return (React.createElement("div", { className: clsx("checkbox-field ", classNames) },
        ...
        React.createElement("div", { className: clsx("checkbox-container", isColumn ? "isColumn" : undefined) }, !isEmpty_1(options) ? (map_1(options, (item, index) => {
            return (React.createElement("div", { key: `${item.value}-${index}`, className: "checkbox-name" },
                React.createElement("input", { className: "checkbox-input", type: "checkbox", name: item.name, id: `${item.name}-${index}`, value: item.value, checked: fieldValue?.includes(item.value), onChange: formikProps.handleChange, disabled: disabled, ...nativeProps }),
                React.createElement("label", { htmlFor: `${item.name}-${index}` }, item.name)));
            ...
            React.createElement("label", { htmlFor: booleanLabel },
                " ",
                booleanLabel)))),
        React.createElement(HelperText, { fieldProps: fieldProps, formikProps: formikProps })));
};
...
const Radio = (props) => {
    ...
    return (React.createElement("div", { className: clsx("radio-field", classNames) },
        ...
        React.createElement("div", { className: clsx("radio-container", isColumn ? "isColumn" : undefined) }, options.map((item, index) => (React.createElement("span", { key: item.value, className: "radio-name" },
            React.createElement("input", { className: "radio-input", type: "radio", name: item.name, id: `${item.name}-${index}`, value: item.value, checked: fieldValue === item.value, onChange: formikProps.handleChange, disabled: disabled, ...nativeProps }),
            React.createElement("label", { htmlFor: `${item.name}-${index}` },
                " ",
                item.name))))),
        React.createElement(HelperText, { fieldProps: fieldProps, formikProps: formikProps })));
};
